...
CREATE TABLE `tb_prescription` (
  ...
  `presTest` varchar(255) DEFAULT NULL,
  `presMedicine` varchar(255) DEFAULT NULL,
  `presAdvice` varchar(255) DEFAULT NULL,
  `presDate` date DEFAULT NULL,
  PRIMARY KEY (`presId`),
  KEY `aId` (`presaId`),
  CONSTRAINT `tb_prescription_ibfk_1` FOREIGN KEY (`presaId`) REFERENCES `tb_appointment` (`aId`)
...
INSERT INTO `tb_prescription` VALUES (1,1,'Test1\r\nTest2','Medicine1\r\nMedicine2','Advice1\r\nAdvice2','2024-08-02');

...
CREATE TABLE `tb_report` (
  ...
  `reportcaId` int NOT NULL,
  `reportDate` date DEFAULT NULL,
  `reportTime` time DEFAULT NULL,
  `reportFile` mediumblob,
  `reportStatus` int DEFAULT '1',
  PRIMARY KEY (`reportId`),
  KEY `reportcaId` (`reportcaId`),
  CONSTRAINT `tb_report_ibfk_1` FOREIGN KEY (`reportcaId`) REFERENCES `tb_centerappointment` (`caId`)
...
INSERT INTO `tb_report` VALUES (1,1,'2024-08-03','21:31:00','',2);
